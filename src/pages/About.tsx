    ...
    <div className="mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-blanc text-gris-canon-de-fusil">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
        <div className="p-6">
          ...
          <p className="text-sm text-gris-canon-de-fusil/70 text-justify">
            Des matériaux certifiés et un contrôle qualité rigoureux à chaque
            étape pour vous garantir le meilleur.
          </p>
        </div>
        <div className="p-6">
        ...
        <div className="p-6">
          ...
          <p className="text-sm text-gris-canon-de-fusil/70 text-justify">
            Un design épuré et une interface intuitive pour une expérience de
            shopping simple, fluide et sécurisée.
          </p>
        </div>
      </div>
    </div>
